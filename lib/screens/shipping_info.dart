...
class _ShippingInfoState extends State<ShippingInfo> {
  ...
  updateEmailVerify(String _phone, String _email) async {
    await AddressRepository()
        ...
        child: Row(
          ...
          children: [
            FlatButton(
              ...
              onPressed: () {
              //d  onPressProceed(context);
               // _displayUpdateEmailInputDialog(context);
                checkEmailVerify(user_phone.$.replaceAll("+91", ""));
              },
            )
          ],
        ),
  ...
  Future<void> _displayUpdateEmailInputDialog(BuildContext context) async {
    return showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
          ...
          content: TextField(
            ...
            decoration: InputDecoration(hintText: "Enter you email address"),
          ),
          actions: <Widget>[
