...
class _HomeState extends State<Home> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    log("message status bar 000000000000000000000000 " +
    ...
    return WillPopScope(
      ...
      child: Directionality(
        ...
        child: Scaffold(
            key: _scaffoldKey,
            backgroundColor: MyTheme.yellow_background,
                  ...
                  child: Padding(
                      padding: app_language_rtl.$
                          ? const EdgeInsets.only(
                              top: 14.0, bottom: 14, left: 12, right: 12)
                          : const EdgeInsets.only(
                              top: 14.0, bottom: 14, right: 12, left: 12),
  ...
  buildHomeSearchBox(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
          ...
          hintStyle: TextStyle(fontSize: 12.0, color: MyTheme.soft_accent_color),
